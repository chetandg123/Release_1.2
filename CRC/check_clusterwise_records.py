            ...
            for y in range(1, len(select_block.options)):
                ...
                for z in range(1, len(select_cluster.options)):
                    ...
                    if nodata == "No data found":
                        ...
                        self.driver.find_element_by_id(Data.Download).click()
                        time.sleep(3)
                        self.filename = p.get_download_dir_CRC_Download2() + "/School_level_CRC_Report.csv"
                        if not os.path.isfile(self.filename):
                            print(select_cluster.options[z].text, " csv file not downloaded")
                        else:
                            with open(self.filename) as fin:
            ...
            for y in range(1, len(select_block.options)):
                ...
                for z in range(1, len(select_cluster.options)):
                    ...
                    if nodata == "No data found":
                        ...
                        self.driver.find_element_by_id(Data.Download).click()
                        time.sleep(3)
                        self.filename = p.get_download_dir_CRC_Download3() + "/School_level_CRC_Report.csv"
                        if not os.path.isfile(self.filename):
                            print(select_cluster.options[z].text, " csv file not downloaded")
                        else:
                            with open(self.filename) as fin:
            ...
            for y in range(1, len(select_block.options)):
                ...
                for z in range(1, len(select_cluster.options)):
                    ...
                    if nodata == "No data found":
                        ...
                        self.driver.find_element_by_id(Data.Download).click()
                        time.sleep(3)
                        self.filename = p.get_download_dir_CRC_Download4() + "/School_level_CRC_Report.csv"
                        if not os.path.isfile(self.filename):
                            print(select_cluster.options[z].text, " csv file not downloaded")
                        else:
                            with open(self.filename) as fin:
